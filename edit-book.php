...
$sql="update  tblbooks set BookName=:bookname,uni_id=:uni_id,quantity=:quantity,pages=:pages,status=:status,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price where id=:bookid";
$query = $dbh->prepare($sql);
$query->bindParam(':bookname',$bookname,PDO::PARAM_STR);
$query->bindParam(':uni_id',$unique,PDO::PARAM_STR);
...
<?php include('theme/admin-sidebar.php');?>
<!-- MENU SECTION END-->
...
<input class="form-control" type="text" name="uni_id" value="<?php echo htmlentities($result->uni_id);?>" required />
</div>

<div class="form-group">
<label>Quantity<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="quantity" value="<?php echo htmlentities($result->quantity);?>" required />
</div>
...
<option value="Missing Pages"> Missing Page </option>
</select>
